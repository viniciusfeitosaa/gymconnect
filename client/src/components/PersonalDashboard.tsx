            ...
            {stats.recentStudents.map(student => (
              ...
              >
                ...
                {student.workoutCount && (
                  ...
                  >
                    {student.workoutCount} treino
                    {student.workoutCount > 1 ? 's' : ''}
                  </div>
                )}
              </div>
            ))}
  ...
  return (
    <div
      style={{
        minHeight: '100vh',
        background:
          'linear-gradient(135deg, #020617 0%, #0c1421 25%, #1e293b 50%, #0c1421 75%, #020617 100%)',
        color: 'white',
      }}
    >
      ...
      >
        ...
        {/* Conteúdo principal */}
        <main
          className={`main-content-mobile ${sidebarOpen ? 'sidebar-open' : ''}`}
          style={{
            flex: 1,
        ...
        >
          <Routes>
            ...
            <Route
              ...
              element={<StudentSpecificWorkouts />}
            />
            <Route
              path="/students/:studentId/workouts/create"
              element={<StudentSpecificNewWorkout />}
            />
